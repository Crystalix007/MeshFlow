...
void myKLT(const cv::Mat source, const cv::Mat target, vector<cv::Point2f>& sourceFeatures,
	...
	cornerSubPix(img0Gray, featurePtSet0, cv::Size(15, 15), cv::Size(-1, -1),
	...
	calcOpticalFlowPyrLK(img0Gray, curImgGray, featurePtSet0, curfeaturePtSet, curFlag, curErrSet,
	                     cv::Size(15, 15));
